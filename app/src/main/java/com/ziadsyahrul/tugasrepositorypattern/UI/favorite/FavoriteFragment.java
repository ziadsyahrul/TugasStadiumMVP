...
import com.ziadsyahrul.tugasrepositorypattern.UI.teams.TeamsAdapter;
...
public class FavoriteFragment extends Fragment implements FavoriteContract.View {
    ...
    @Override
    public void showDataList(List<TeamsData> teamsDataList) {
        rvFavorite.setLayoutManager(new LinearLayoutManager(getContext()));
        rvFavorite.setAdapter(new TeamsAdapter(getContext(), teamsDataList));
    }
